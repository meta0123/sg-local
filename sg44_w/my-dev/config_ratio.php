...
特碼=[N,單,雙,大,小,N號以上]
*/
$aryExtSet[1]=array(0,array(),array());
$aryExtSet[1][1]=array(array(0,4,6,8,10),array(0,27,27.1,27.15,27.2,27.2));
$aryExtSet[1][2]=array(30,36.5,37,37.5,38,38.5);

$aryExtSet[2]=array(0,array(),array());
$aryExtSet[2][1]=array(array(0,4,6,8,10),array(0,27,27.1,27.15,27.2,27.2));
$aryExtSet[2][2]=array(30,36.5,37,37.5,38,38.5);

$aryExtSet[3]=array(0,array(),array());
$aryExtSet[3][1]=array(array(0,4,6,8,10),array(0,28.1,28.1,28.2,28.2));
$aryExtSet[3][2]=array(30,36.5,37,37.5,38,38.5);
//八面賠率
$aryEvtSet=array();
$aryEvtSet[0]=0;
/*
...
if(file_exists(Data_Path."w_guprto.php")){
	include(Data_Path."w_guprto.php");
}
if(file_exists(pathTxt."Ratio/DataRatio.php")){
	include(pathTxt."Ratio/DataRatio.php");
}
?>